...
const CallToAction = () => {
  return (
    <section className="bg-[#3C3E41] pb-10">
      <div className="max-w-screen-lg px-10 mx-auto text-white sm:p-10">
        <div>
          <SectionTitle title={`Follow my updates per month`}/>
        ...
        <div>
          <form className="flex flex-col justify-center gap-2 sm:flex-row">
            <input type="email" placeholder="Your Email" className="py-2 text-center sm:w-96" />
